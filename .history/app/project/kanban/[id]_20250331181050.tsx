  ...
  const [columns, setColumns] = useState<KanbanColumn[]>([
    {
      ...
      cards: [
        ...
        { id: '2', title: 'Deadline Management', comments: 12, hasNotification: true },
        { id: '3', title: 'Networking Assistance', comments: 12, hasNotification: true },
        { id: '4', title: 'Data Security Assurance', comments: 12, hasNotification: true },
        { id: '5', title: 'Continuous Feedback Loop', comments: 12, hasNotification: true },
      ]
    },
    {
      id: 'in-process',
      ...
      color: '#FFC466',
      cards: [
        { id: '6', title: 'Application Tracking', comments: 12 },
        { id: '7', title: 'Automated Job Alerts', comments: 12 },
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabBar}>
        <TouchableOpacity style={styles.tabButton}>
          <Ionicons name="home-outline" size={24} color="#D3B8AD" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.tabButton}>
          <Ionicons name="calendar-outline" size={24} color="#D3B8AD" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.addTaskButton}>
          <Ionicons name="add" size={28} color="#FFF" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.tabButton}>
          <Ionicons name="document-text-outline" size={24} color="#D3B8AD" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.tabButton}>
          <Ionicons name="person-outline" size={24} color="#D3B8AD" />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
