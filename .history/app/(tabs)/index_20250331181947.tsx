...
const Home = () => {
    ...
    const teamData: TeamData[] = [
        { id: 1, name: "John Doe", role: "UI Designer", avatar: "https://i.pravatar.cc/150?img=1" },
        { id: 2, name: "Jane Smith", role: "Developer", avatar: "https://i.pravatar.cc/150?img=2" },
        { id: 3, name: "Mike Johnson", role: "Project Manager", avatar: "https://i.pravatar.cc/150?img=3" },
    ];
