...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, ScrollView, Platform, DateTimePickerAndroid } from "react-native";
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.inputContainer}>
                    <TextInput
                        ...
                        editable={false}
                    />
                    <TouchableOpacity style={styles.inputIcon} onPress={openDatePicker}>
